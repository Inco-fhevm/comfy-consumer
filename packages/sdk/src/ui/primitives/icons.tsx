...
export function ForwardIcon({ size = 16, ...props }: IconProps) {
  return (
    <svg {...base({ size, ...props })}>
...
// Base mark, from base/brand-kit.
export function BaseIcon({ size = 16 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 1280 1280" aria-hidden="true">
      <path
        fill="#0000FF"
